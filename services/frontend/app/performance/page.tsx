...
function ConcentrationBar({
  ...
  return (
    ...
    >
      <span className="w-24 text-sm font-medium text-neutral-700 truncate">
        {friendlyAsset(asset)}
      </span>
      ...
      <span className="w-14 text-right font-mono text-sm font-medium text-neutral-600">
    ...
    return (
      <main className="grid gap-6">
        {[0, 1, 2].map((i) => (
          <div
            key={i}
            className="rounded-xl border border-neutral-200 bg-white p-6 animate-pulse h-40"
          />
        ))}
      </main>
    );
