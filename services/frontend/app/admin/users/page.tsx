      ...
      <PageTransition>
        <main className="grid gap-6">
          ...
          <section className="rounded border border-[#2e2e2e] bg-[#111111] p-6">
            <p className="text-sm font-medium uppercase tracking-wider text-[#a1a1a1]">USERS</p>
          ...
          <StaggerContainer className="grid gap-4 sm:grid-cols-3">
            <StaggerItem>
              <div className="rounded border border-[#2e2e2e] bg-[#111111] p-6 text-center">
                <p className="text-xs font-medium uppercase tracking-wider text-[#a1a1a1]">전체 사용자</p>
            ...
            <StaggerItem>
              <div className="rounded border border-[#2e2e2e] bg-[#111111] p-6 text-center">
                <p className="text-xs font-medium uppercase tracking-wider text-[#a1a1a1]">관리자</p>
                <p className="mt-1 font-mono text-2xl font-semibold text-white">
                  {adminCount}
                </p>
              </div>
            ...
            <StaggerItem>
              <div className="rounded border border-[#2e2e2e] bg-[#111111] p-6 text-center">
                <p className="text-xs font-medium uppercase tracking-wider text-[#a1a1a1]">일반 사용자</p>
                <p className="mt-1 font-mono text-2xl font-semibold text-white">
          ...
          {/* User Table */}
          <section className="rounded border border-[#2e2e2e] bg-[#111111] p-3 sm:p-6">
            <div className="-mx-3 sm:mx-0 overflow-x-auto">
            <table className="w-full min-w-[640px] text-left text-sm">
              <thead>
                <tr className="border-b border-[#2e2e2e] text-xs font-medium uppercase tracking-wider text-[#a1a1a1]">
              ...
              <tbody>
                {users.length > 0 ? (
                  users.map((user, index) => (
                    ...
                    >
                      ...
                      <td className="py-3 pr-4">
                        <span className="inline-flex items-center rounded-full bg-[#1c1c21] px-2 py-0.5 text-xs font-medium text-[#a1a1a1]">
                          {user.plan}
                        </span>
                      </td>
                      <td className="py-3 pr-4">
                        <select
                          ...
                          className="rounded border border-[#2e2e2e] bg-[#111111] px-3 py-1.5 text-xs text-white outline-none focus:border-white/[0.30] transition-colors duration-200"
                        >
                          <option value="user">user</option>
                          <option value="admin">admin</option>
                        </select>
                      </td>
                      <td className="py-3 pr-4 text-xs text-[#a1a1a1] hidden sm:table-cell">
                  ...
                  <tr>
                    <td colSpan={5} className="py-8 text-center text-[#a1a1a1]">
                      사용자를 찾을 수 없습니다.
                    </td>
                  </tr>
                )}
